...
ROOT=Path(__file__).resolve().parents[1]; P=ROOT/'sources/pcc-poker-v0.8.0'; L=ROOT/'sources/pcc-liars-dice-v0.5.0'; R=ROOT/'sources/pcc-rps-v0.2.0'; M=ROOT/'sources/pcc-micro-fighter-v0.8.0'
...
def test_micro_chaos_is_not_imputed(): assert all(v['status']=='unresolved' for v in report()['games']['micro-fighter'].values())
