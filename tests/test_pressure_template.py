...
def report(): return build_pressure_template_benchmark(ROOT/'sources/pcc-poker-v0.8.0',ROOT/'sources/pcc-liars-dice-v0.5.0',ROOT/'sources/pcc-rps-v0.2.0',ROOT/'sources/pcc-micro-fighter-v1.0.0')
